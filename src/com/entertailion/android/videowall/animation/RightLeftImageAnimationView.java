 ...
 */
public class RightLeftImageAnimationView extends ImageAnimationView {
	 ...
	 *            The view's height.
	 */
	public RightLeftImageAnimationView(Context context, final ImageAnimationListener listener, int width, int height) {
